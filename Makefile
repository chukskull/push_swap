...
B_DIR = build
SRC = push_swap utils/used_func /utils/algo_500 utils/sending_chunks utils/last_chunk utils/pushing_chunks_to_b utils/pushing_max_to_a utils/pushing utils/swaping utils/rotation utils/ft_atoi list/ft_lstnew list/ft_lstadd_back list/ft_lstlast list/ft_lstdelone list/ft_lstadd_front list/ft_lstclear list/ft_lstnew list/ft_lstsize
